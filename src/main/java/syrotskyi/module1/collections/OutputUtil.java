...
public class OutputUtil {
    ...
    private static void writeHeaderToFile(String header) throws IOException {
        ...
        String fileName = userDir + fileSeparator + "src" + fileSeparator + "main" + fileSeparator + "java" +
                fileSeparator + "syrotskyi" + fileSeparator + "module1" + fileSeparator + "collections" + fileSeparator +
                "savedResults" + fileSeparator +"results.txt";
